        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-10">
          ...
          <div className="text-center md:text-left space-y-6 md:w-1/2">
            ...
            <div className="opacity-0 animate-fade-in-delay-4 flex flex-col md:flex-row items-center justify-center md:justify-start gap-3">
              ...
              <a href="https://drive.google.com/file/d/1SN_ST_rFZd9xGjeoguww8tlq-eXKVvsy/view?usp=sharing" target="_blank" className="reverse-button flex items-center gap-2">
